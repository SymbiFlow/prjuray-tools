...
public:
  ...
  static const std::unordered_map<std::string, size_t> words_in_architecture;
  static std::shared_ptr<ConfigurationPackets>
  InitFromFile(const std::string &file, const std::string &arch);
...
private:
  ...
  bool IsDifferentRow(ConfigurationFrames::const_iterator frame_citr1,
