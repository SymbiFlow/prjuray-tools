...
Configuration<Spartan6>::createType2ConfigurationPacketData(
  ...
  packet_data.insert(packet_data.begin(), (packet_data_size >> 16) & 0xFFFF);
  return packet_data;
}

template <>
void Configuration<Spartan6>::createConfigurationPackage(
    Spartan6::ConfigurationPackage &out_packets, const PacketData &packet_data,
    absl::optional<Spartan6::Part> &part) {
...
void Configuration<Series7>::createConfigurationPackage(
    Series7::ConfigurationPackage &out_packets, const PacketData &packet_data,
...
void Configuration<UltraScale>::createConfigurationPackage(
    ...
    const PacketData &packet_data, absl::optional<UltraScale::Part> &part) {
...
void Configuration<UltraScalePlus>::createConfigurationPackage(
    ...
    const PacketData &packet_data, absl::optional<UltraScalePlus::Part> &part) {
