...
constexpr uint32_t MakeType2(const int opcode, const int word_count) {
  return prjxray::bit_field_set<uint32_t>(
      prjxray::bit_field_set<uint32_t>(
          prjxray::bit_field_set<uint32_t>(0x0, 31, 29, 0x2), 28, 27, opcode),
      26, 0, word_count);
}
...
TEST(BitstreamWriterTest, WriteType0) {
  ...
  std::vector<uint32_t> ref{// Bus width + sync
                            0x0FFFFFFFF, 0x0FFFFFFFF, 0x0FFFFFFFF, 0x0FFFFFFFF,
                            0x0FFFFFFFF, 0x0FFFFFFFF, 0x0FFFFFFFF, 0x0FFFFFFFF,
                            0x0000000BB, 0x011220044, 0x0FFFFFFFF, 0x0FFFFFFFF,
                            0x0AA995566,
                            // Type 0
                            0x00000000};
  EXPECT_EQ(words, ref);
