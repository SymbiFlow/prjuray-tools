...
TEST(GlobalClockRegionTest, IsValidFrameAddress) {
  ...
  addresses.push_back(xc7series::FrameAddress(xc7series::BlockType::CLB_IO_CLK,
                                              false, 0, 0, 0));
  addresses.push_back(xc7series::FrameAddress(xc7series::BlockType::CLB_IO_CLK,
                                              false, 0, 0, 1));
  addresses.push_back(xc7series::FrameAddress(xc7series::BlockType::CLB_IO_CLK,
  ...
  addresses.push_back(
      xc7series::FrameAddress(xc7series::BlockType::BLOCK_RAM, false, 0, 0, 1));
  addresses.push_back(
      xc7series::FrameAddress(xc7series::BlockType::BLOCK_RAM, false, 0, 0, 2));
  addresses.push_back(xc7series::FrameAddress(xc7series::BlockType::CLB_IO_CLK,
                                              false, 1, 0, 0));
  addresses.push_back(xc7series::FrameAddress(xc7series::BlockType::CLB_IO_CLK,
                                              false, 1, 0, 1));
  ...
  EXPECT_TRUE(global_clock_region.IsValidFrameAddress(xc7series::FrameAddress(
  ...
  EXPECT_FALSE(global_clock_region.IsValidFrameAddress(xc7series::FrameAddress(
  ...
  EXPECT_FALSE(global_clock_region.IsValidFrameAddress(
      xc7series::FrameAddress(xc7series::BlockType::CFG_CLB, false, 0, 0, 2)));
}
...
TEST(GlobalClockRegionTest,
  ...
  EXPECT_FALSE(global_clock_region.GetNextFrameAddress(xc7series::FrameAddress(
