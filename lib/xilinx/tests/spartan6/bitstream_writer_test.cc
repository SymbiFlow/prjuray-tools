...
extern const uint32_t MakeType1(const int opcode, const int address,
                                const int word_count);

extern const std::vector<uint32_t>
MakeType2(const int opcode, const int address, const int word_count);
...
TEST(BitstreamWriterTest, WriteHeader) {
  ...
  std::vector<uint32_t> ref_header{0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
...
TEST(BitstreamWriterTest, WriteType0) {
  ...
  std::vector<uint32_t> words(writer.begin(), writer.end());
  std::vector<uint32_t> ref{0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
                            0xFFFF, 0xFFFF, 0xAA99, 0x5566,
                            // Type 0
                            0x0000};
  EXPECT_EQ(words, ref);
}
...
TEST(BitstreamWriterTest, WriteType2) {
  ...
  std::vector<uint32_t> ref{// Bus width + sync
                            0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF,
                            0xFFFF, 0xFFFF, 0xAA99, 0x5566, 0x5060, 0x0001,
...
TEST(BitstreamWriterTest, WriteMulti) {
  ...
  std::vector<uint32_t> ref{// Bus width + sync
                            ...
                            0x5060, 0x0001, 0x0002, 0x0003, 0x0004, 0x0005,
