...
TEST(FramesTest, FillInMissingFrames) {
  ...
  frames.getFrames().emplace(std::make_pair(spartan6::FrameAddress(2),
                                            std::vector<uint32_t>(65, 0xCC)));
  frames.getFrames().emplace(std::make_pair(spartan6::FrameAddress(3),
                                            std::vector<uint32_t>(65, 0xDD)));
  frames.getFrames().emplace(std::make_pair(spartan6::FrameAddress(4),
