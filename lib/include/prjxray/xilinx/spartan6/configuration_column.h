...
public:
  ...
  template <typename T> ConfigurationColumn(T first, T last);
...
namespace YAML {
template <> struct convert<prjxray::xilinx::spartan6::ConfigurationColumn> {
  static Node encode(const prjxray::xilinx::spartan6::ConfigurationColumn &rhs);
