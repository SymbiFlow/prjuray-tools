...
public:
  ...
  public:
    ...
    bool operator==(iterator other) const { return view_ == other.view_; }
  ...
  protected:
    explicit iterator(absl::string_view view) : view_(view), value_(view) {}
  ...
  static std::unique_ptr<SegbitsFileReader>
  InitWithFile(const std::string &path);
