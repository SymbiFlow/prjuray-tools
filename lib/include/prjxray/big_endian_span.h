...
template <typename WordType, typename ByteType> class BigEndianSpan {
public:
  ...
  constexpr reference at(size_type pos) const { return this->operator[](pos); }
...
BigEndianSpan<WordType, typename Container::value_type>
make_big_endian_span(Container &bytes) {
