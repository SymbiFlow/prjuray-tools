...
from .grid_types import BlockType, GridLoc, GridInfo, BitAlias, Bits, BitsInfo, ClockRegion
from .tile_segbits_alias import TileSegbitsAlias
import re
    ...
    def __init__(self, db, tilegrid):
        ...
        for tile in self.tilegrid:
            ...
            self.tileinfo[tile] = GridInfo(
                ...
                prohibited_sites=tileinfo.get('prohibited_sites', {}),
